                    ...
                    <div class="container mx-auto">
                        ...
                        @auth
                            <form method="post" action="{{ route('buku.favorite', ['id' => $bukus->id]) }}">
                                @csrf
                                <button type="submit" class="bg-green-500 text-white py-2 px-4 rounded">Save to Favorites</button>
                            </form>
                        @endauth
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <div class="flex">
                               <!-- Display stars based on the average rating -->
                                @for($i = 1; $i <= 5; $i++)
                                    <form method="post" action="{{ route('buku.rate', ['id' => $bukus->id, 'rating' => $i]) }}">
                                        @csrf
